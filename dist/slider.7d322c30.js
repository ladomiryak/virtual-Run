...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"app/js/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.debounce = exports.splitWord = void 0;

var splitWord = function splitWord(element) {
...
},{}],"app/js/slider.js":[function(require,module,exports) {
"use strict";
...
var sliding = false;
var titles = document.querySelectorAll(".section .section-title");
var text = document.querySelectorAll(".section .section-text");
...
var slide = function slide() {
  ...
  var $currentSlideTitleChars = titles[currentSlide].children;
  var $nextSlideTitleChars = titles[nextSlide].children;
  var $slideText = text[nextSlide].children;
  var $slideButton = buttons[nextSlide];
  var ease = {
    ease: _gsap.Power1.easeInOut
  };
  sliding = true;

  _gsap.default.to(_toConsumableArray($currentSlideTitleChars), _objectSpread({
    opacity: 0,
    stagger: 0.01
  }, ease)).delay();

  _gsap.default.to($currentSlide, _objectSpread({
    duration: 0.5,
    x: -130,
    y: 0,
    z: -150,
    opacity: 0
  }, ease)).eventCallback("onComplete", function () {
    $currentSlide.classList.remove("active");
    $nextSlide.classList.add("active");
    currentSlide = nextSlide;
    $body.classList.add("step-".concat(currentSlide + 1));
    $body.classList.remove("step-".concat(currentSlide === 0 ? slideLength : currentSlide));
    setActiveNavItem();
    scroll = 0;

    _gsap.default.to($body, _objectSpread({
      backgroundImage: "linear-gradient(".concat(gradientColors[currentSlide + 1].color1, ",").concat(gradientColors[currentSlide + 1].color2, ")"),
      duration: 1
    }, ease));

    _gsap.default.fromTo($nextSlide, 0.5, _objectSpread({
      x: 130,
      y: 0,
      z: 150,
      opacity: 0
    ...
    _gsap.default.fromTo(_toConsumableArray($nextSlideTitleChars), {
      opacity: 0
    }, {
      opacity: 1,
      stagger: 0.04
    ...
    _gsap.default.from(_toConsumableArray($slideText), 0.5, _objectSpread({
      y: 35,
      opacity: 0,
      stagger: 0.1
    }, ease)).delay(0.2);

    _gsap.default.from($slideButton, _objectSpread({
      duration: 0.5,
      y: 35,
      opacity: 0
    }, ease)).delay(0.3);
...
var setActiveNavItem = function setActiveNavItem() {
  var navItems = document.querySelectorAll(".slider-nav")[0].children;

  _toConsumableArray(navItems).map(function (item, i) {
...
var initSlideNav = function initSlideNav() {
  var body = document.body;
...
initSlideNav();
window.addEventListener("wheel", (0, _utils.debounce)(function (event) {
  if (event.wheelDelta < 0 && !sliding) {
    slide();
  }
}, 2000));
document.body.addEventListener("click", (0, _utils.debounce)(function () {
  slide();
}, 2000));
},{"gsap":"node_modules/gsap/index.js","./utils.js":"app/js/utils.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/js/slider.js"], null)
//# sourceMappingURL=/slider.7d322c30.js.map